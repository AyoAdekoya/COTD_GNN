...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
#                                                                 #
#            PREPROCESSING/CREATING GRAPH FROM NETLIST            #
#                                                                 #
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
...
training_filepairs = []
for i in range(16):
    training_filepairs.append((f'Trojan_GNN\\test-cases\\trojan\\design{i}.v', 
                               f'Trojan_GNN\\test-cases\\trojan\\result{i}.txt'))

testing_filepairs = []
for i in range(16, 20):
    testing_filepairs.append((f'Trojan_GNN\\test-cases\\trojan\\design{i}.v', 
                               f'Trojan_GNN\\test-cases\\trojan\\result{i}.txt'))
...
def trojanlabel(reffilepath):
    ...
    with open(reffilepath, 'r') as file:
        ...
        #read from line 2 and stop at line -1
...
def parse_verilog_netlist(filepath, reffilepath):
    ...
    for pi in primary_inputs:
        G.add_node(pi, type='PI', label="Not_Trojaned")

    # Add PO nodes
    for po in primary_outputs:
        G.add_node(po, type='PO', label="Not_Trojaned")

    # Add constant nodes
    G.add_node("CONST_0", type="CONST", label="Not_Trojaned")
    G.add_node("CONST_1", type="CONST", label="Not_Trojaned")
...
filepath, reffilepath = testing_filepairs[0]
